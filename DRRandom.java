 ...
 *
 * Compilation:  avac DRRandom.java
 * Execution:    java DRRandom
...
public final class DRRandom {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 2)
            DRRandom.setSeed(Long.parseLong(args[1]));
        double[] probabilities = { 0.5, 0.3, 0.1, 0.1 };
        int[] frequencies = { 5, 3, 1, 1 };
        String[] a = "A B C D E F G".split(" ");

        DROut.println("seed = " + DRRandom.getSeed());
        for (int i = 0; i < n; i++) {
            DROut.printf("%2d ",   uniform(100));
            DROut.printf("%8.5f ", uniform(10.0, 99.0));
            DROut.printf("%5b ",   bernoulli(0.5));
            DROut.printf("%7.5f ", gaussian(9.0, 0.2));
            DROut.printf("%1d ",   discrete(probabilities));
            DROut.printf("%1d ",   discrete(frequencies));
            DROut.printf("%11d ",  uniform(100000000000L));
            DRRandom.shuffle(a);
            for (String s: a)
                DROut.print(s);
            DROut.println();
